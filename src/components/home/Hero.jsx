  ...
  return (
    <div className="flex flex-wrap justify-center md:justify-between  items-center m-auto my-10 bg-primary text-white rounded-lg">
      <div className="left md:w-1/2 md:px-20 p-10 w-full ">
        ...
        <img src={assets.herotext} alt="" />
        <div className="flex items-center py-4">
          <span>
            <img src={assets.group_profiles} className="w-52 px-4" alt="" />
          </span>
        ...
        <Link to="/doctors/all">
          <button
            className="rounded-md bg-white  p-4 border border-transparent text-center text-sm text-primary transition-all shadow-md hover:shadow-lg  flex items-center m-auto md:m-0"
            type="button"
          >
            Book Appointment
            <span className="px-2">
