    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start">
        ...
        <div className="md:w-2/3 md:ml-8 text-center md:text-left mt-4 md:mt-0">
          <h1 className="font-bold flex items-center justify-center md:justify-start my-2 text-lg text-primary">
            What We Believe
          </h1>
          ...
          <h1 className="font-bold text-lg flex items-center justify-center md:justify-start my-2 text-primary">
            Our Vision
          </h1>
          <p className="text-md text-gray-600">
            Our vision at Prescripto is to create a seamless healthcare
            experience for every user. By offering services like Free Checkups,
            Emergency Services, and Health Consultations, we aim to bridge the
